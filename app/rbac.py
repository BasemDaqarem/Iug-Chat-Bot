...
ROLE_PROMPTS = {
    Role.GUEST: (
        ...
        "الزائر غالباً طالب ثانوية عامة يستكشف التسجيل: إذا ذكر «معدلي» فالمقصود "
        "معدل الثانوية العامة (التوجيهي)، وأسئلته عن القبول تُجاب بمقارنة معدله "
        "بمعدلات قبول التخصصات — لا بشروط المنح."
    ),
    Role.STUDENT: (
