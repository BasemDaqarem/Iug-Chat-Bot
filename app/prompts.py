...
10. إذا أشار السؤال إلى موضوع سابق في سجل المحادثة (مثل «هذا الطلب»، «نفس الموضوع»، «كم يكلفني؟»)،
   فحدّد المقصود من سجل المحادثة أولاً ثم أجب عنه من المقاطع أعلاه — لا تفترض موضوعاً آخر.
